...
///
/// Changing About content is a config edit, not a code change. See the folder
/// guideline section 1 for the fixed pattern (`AppConfig` + `ConfigService`).
class AppConfig {
  ...
  /// Reads field by field and falls back per field on a missing value or wrong
  /// type. Never throws.
